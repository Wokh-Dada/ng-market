...
import {MarketOrderingInterface, MarketOrderingModalsInterface} from 's-market';
...
export const marketProductsListAdmin = [
  {
    id: 1,
    img: 'https://d2j6dbq0eux0bg.cloudfront.net/default-store/white_tank_160px.jpg',
    type: 'Образец' ,
    title: 'Белый топ',
    article: 9,
    inStock: true,
...
export const orderingLogo = 'http://via.placeholder.com/200x50?img=Img';

export const ordering: MarketOrderingInterface = {
  method: {
    id: 1,
...
export const orderingModals: MarketOrderingModalsInterface = {
  promoCode: {
    ...
    toolbarHeadBtn: [
      {
        ...
        btnIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" focusable="false">
